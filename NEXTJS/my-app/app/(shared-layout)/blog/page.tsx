...
async function BlogPosts() {
  ...
  if (!posts || posts.length === 0) {
    return (
    <div className="flex flex-col items-center justify-center min-h-100 p-8 text-center bg-gray-50 border border-dashed border-gray-300 rounded-xl">
      ...
      <p className="mt-1 text-sm text-gray-500 max-w-sm">We couldn't find any articles right now. Check back later or try refreshing the page.</p>
    </div>
    );
  }
